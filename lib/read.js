...
exports.mdLinks = exports.onlyStatusLinks = exports.onlyStats = exports.onlyBrokesLinks = exports.mdFiles = exports.readDir = exports.getArrayOfObjectsLinks = void 0;
...
var getLinks = function getLinks(absolutePath) {
  return new Promise(function (resolve, reject) {
    resolve(mdFiles(absolutePath).map(function (pathMd) {
